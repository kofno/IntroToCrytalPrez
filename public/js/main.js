...
var _user$project$Types$SetSlide = function (a) {
	return {ctor: 'SetSlide', _0: a};
};
var _user$project$Types$Goto = function (a) {
	return {ctor: 'Goto', _0: a};
};
var _user$project$Types$Awesome = {ctor: 'Awesome'};
var _user$project$Types$JustASec2 = {ctor: 'JustASec2'};
var _user$project$Types$Parallelism = {ctor: 'Parallelism'};
var _user$project$Types$ConcurrencyExample = {ctor: 'ConcurrencyExample'};
var _user$project$Types$Concurrency = {ctor: 'Concurrency'};
var _user$project$Types$Macros = {ctor: 'Macros'};
var _user$project$Types$CBinding = {ctor: 'CBinding'};
var _user$project$Types$Overloaded = {ctor: 'Overloaded'};
var _user$project$Types$UnionTypes = {ctor: 'UnionTypes'};
var _user$project$Types$CrystalExample = {ctor: 'CrystalExample'};
var _user$project$Types$JustASec = {ctor: 'JustASec'};
var _user$project$Types$RailsEh = {ctor: 'RailsEh'};
var _user$project$Types$HelloWeb = {ctor: 'HelloWeb'};
var _user$project$Types$HelloWorld = {ctor: 'HelloWorld'};
var _user$project$Types$Cover = {ctor: 'Cover'};
var _user$project$Types$slideOrder = _elm_lang$core$Native_List.fromArray(
	[_user$project$Types$Cover, _user$project$Types$HelloWorld, _user$project$Types$HelloWeb, _user$project$Types$RailsEh, _user$project$Types$JustASec, _user$project$Types$CrystalExample, _user$project$Types$UnionTypes, _user$project$Types$Overloaded, _user$project$Types$CBinding, _user$project$Types$Macros, _user$project$Types$Concurrency, _user$project$Types$ConcurrencyExample, _user$project$Types$Parallelism, _user$project$Types$JustASec2, _user$project$Types$Awesome]);
var _user$project$Types$previousSlide = function (current) {
	return _elm_lang$core$List$head(
		A2(
			...
			A2(
				...
				_elm_lang$core$List$reverse(_user$project$Types$slideOrder))));
};
var _user$project$Types$nextSlide = function (current) {
	return _elm_lang$core$List$head(
		A2(
			_elm_lang$core$List$drop,
			1,
			A2(
				...
				_user$project$Types$slideOrder)));
};
var _user$project$Types$initialModel = {slide: _user$project$Types$Cover, transition: _etaque$elm_transit$Transit$empty};
var _user$project$Types$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_user$project$Types$initialModel,
	_elm_lang$core$Native_List.fromArray(
		[]));

var _user$project$Awesome_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('hero-body has-text-centered'),
				_elm_lang$html$Html_Attributes$style(
				A2(_etaque$elm_transit_style$TransitStyle$fadeSlide, 200, model.transition))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href('http://awesome-crystal.com/'),
								_elm_lang$html$Html_Attributes$style(
								_elm_lang$core$Native_List.fromArray(
									[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('C Bindings')
							])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(_user$project$CBinding_View$exampleCode)
							]))
					]))
			]));
};

var _user$project$Concurrency_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Concurrency')
							])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('CSP (think goroutines)')
									])),
								A2(
								_elm_lang$html$Html$li,
								_elm_lang$core$Native_List.fromArray(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Fibers and Channels')
									])),
								A2(
								_elm_lang$html$Html$li,
								_elm_lang$core$Native_List.fromArray(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('*Not Ruby Fibers')
									]))
							]))
					]))
			]));
...
var _user$project$ConcurrencyExample_View$exampleCode = '\ntable = Channel(Int32).new\n3.times { spawn player(table) }\n\ntable.send 0\nsleep 1.second\nputs table.receive\nputs\n\ndef player(table)\n  loop {\n    ball = table.receive\n    ball += 1\n    sleep 100.milliseconds\n    table.send(ball)\n  }\nend\n';
var _user$project$ConcurrencyExample_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(_user$project$ConcurrencyExample_View$exampleCode)
							]))
					]))
			]));
};

var _user$project$Cover_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$src('/images/crystal-logo.png'),
								_elm_lang$html$Html_Attributes$title('Crystal: The Programming Language')
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Crystal')
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('A Ruby-like Language with Types')
							]))
					]))
			]));
};

var _user$project$CrystalExample_View$exampleCode = '\nmodule Scry\n  class Analyzer\n    private getter workspace : Workspace\n    private getter text_document : TextDocument\n\n    def initialize(@workspace, @text_document)\n    end\n\n    def run\n      text.map { |t| analyze(t) }.flatten.uniq\n    end\n\n    # ... and so on\n  end\nend\n';
var _user$project$CrystalExample_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(_user$project$CrystalExample_View$exampleCode)
							]))
					]))
			]));
};

var _user$project$HelloWeb_View$codeExample = '\n# A very basic HTTP server\nrequire \"http/server\"\n\nserver = HTTP::Server.new(8080) do |context|\n  context.response.content_type = \"text/plain\"\n  context.response.print \"Hello world, got #{context.request.path}!\"\nend\n\nputs \"Listening on http://0.0.0.0:8080\"\nserver.listen\n';
var _user$project$HelloWeb_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Hello Web???')
							])),
						A2(
						_elm_lang$html$Html$pre,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('ruby'),
								_elm_lang$html$Html_Attributes$style(
								_elm_lang$core$Native_List.fromArray(
									[
										{ctor: '_Tuple2', _0: 'text-align', _1: 'left'}
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(_user$project$HelloWeb_View$codeExample)
							]))
					]))
			]));
};

var _user$project$HelloWorld_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('puts \"Hello, World!\"')
							]))
					]))
			]));
};

var _user$project$JustASec_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Just a Second There Professor...')
							])),
						A2(
						_elm_lang$html$Html$img,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$src('/images/justASec.jpg'),
								_elm_lang$html$Html_Attributes$title('Office Space Image')
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					]))
...
var _user$project$Macros_View$exampleCode = '\nmacro define_method(name, content)\n  def {{name.id}}\n    {{content}}\n  end\nend\n\n# This correctly generates:\n#\n#     def foo\n#       1\n#     end\ndefine_method :foo, 1\n';
var _user$project$Macros_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Macros')
							])),
						A2(
						_elm_lang$html$Html$pre,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(_user$project$Macros_View$exampleCode)
							]))
					]))
			]));
};

var _user$project$RailsEh_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Rails!!??')
							]))
					]))
			]));
};

var _user$project$UnionTypes_View$exampleCode = '\nif 1 + 2 == 3\n  a = 4          # 4 : Int32\nelse\n  a = nil        # nil : Nil\nend\n\ntypeof(a)        # (Int32 | Nil)\n\na + 1            # Compiler error!\n';
var _user$project$UnionTypes_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Union Types')
							])),
						A2(
						_elm_lang$html$Html$pre,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(_user$project$UnionTypes_View$exampleCode)
							]))
					]))
			]));
};

var _user$project$Overloaded_View$exampleCode = '\ndef addOne(value : Int32)\n  value + 1\nend\n\ndef addOne(value : Nil)\n  nil\nend\n\naddOne(a)                  # 5 : Int32\naddOne(nil)                # nil : Nil\n';
var _user$project$Overloaded_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Method Overloading')
							])),
						A2(
						_elm_lang$html$Html$pre,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(_user$project$Overloaded_View$exampleCode)
							]))
					]))
			]));
};

var _user$project$Parallelism_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Parallelism!!??')
							]))
					]))
			]));
};

var _user$project$View$previousSlide = function (model) {
	var _p0 = _user$project$Types$previousSlide(model.slide);
	if (_p0.ctor === 'Nothing') {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$Types$Goto(_p0._0))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$View$nextSlide = function (model) {
	var _p1 = _user$project$Types$nextSlide(model.slide);
	if (_p1.ctor === 'Nothing') {
		return _elm_lang$html$Html$text('');
	} else {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(
					_user$project$Types$Goto(_p1._0))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$View$footNav = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$View$previousSlide(model)
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$View$nextSlide(model)
							]))
					]))
			]));
};
var _user$project$View$heroFoot = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('hero-foot')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$View$footNav(model)
			]));
};
var _user$project$View$renderSlide = function (model) {
	var _p2 = model.slide;
	switch (_p2.ctor) {
		case 'Cover':
			return _user$project$Cover_View$root(model);
		case 'HelloWorld':
			return _user$project$HelloWorld_View$root(model);
		case 'HelloWeb':
			return _user$project$HelloWeb_View$root(model);
		case 'RailsEh':
			return _user$project$RailsEh_View$root(model);
		case 'JustASec':
			return _user$project$JustASec_View$root(model);
		case 'CrystalExample':
			return _user$project$CrystalExample_View$root(model);
		case 'UnionTypes':
			return _user$project$UnionTypes_View$root(model);
		case 'Overloaded':
			return _user$project$Overloaded_View$root(model);
		case 'CBinding':
			return _user$project$CBinding_View$root(model);
		case 'Macros':
			return _user$project$Macros_View$root(model);
		case 'Concurrency':
			return _user$project$Concurrency_View$root(model);
		case 'ConcurrencyExample':
			return _user$project$ConcurrencyExample_View$root(model);
		case 'Awesome':
			return _user$project$Awesome_View$root(model);
		case 'Parallelism':
			return _user$project$Parallelism_View$root(model);
		default:
			return _user$project$JustASec_View$root(model);
	}
};
var _user$project$View$root = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('hero is-fullheight'),
				_elm_lang$html$Html_Attributes$id('intro')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$View$renderSlide(model),
				_user$project$View$heroFoot(model)
			]));
};
		...
		switch (_p0.ctor) {
			case 'Goto':
				return A4(
					...
					_user$project$Types$SetSlide(_p0._0),
...
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Types$init, update: _user$project$State$update, view: _user$project$View$root, subscriptions: _user$project$State$subscriptions})
};
